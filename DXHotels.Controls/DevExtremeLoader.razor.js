...
function loadDevExtreme() {
    return devExtremeInitPromise || (devExtremeInitPromise = new Promise(async (resolve, _) => {
        try {
            ...
            await loadScriptAsync("https://cdn3.devexpress.com/jslib/23.2.3/js/dx.all.js");
            await loadStylesheetAsync("https://cdn3.devexpress.com/jslib/23.2.3/css/dx.common.css");
            await loadStylesheetAsync("https://cdn3.devexpress.com/jslib/23.2.3/css/dx.material.orange.light.compact.css");
            resolve();
        }
        catch (err) {
            console.log(err);
